...
public class DataGenerator {
    ...
    public static String generateCity() {
        ...
        String [] cities = new String[] { "Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Магас",
                ...
                "Киров", "Кострома", "Курган", "Курск", "Липецк", "Магадан", "Москва", "Мурманск", "Нижний Новгород",
                ...
                "Ульяновск", "Челябинск", "Ярославль", "Санкт-Петербург", "Севастополь", "Биробиджан", "Нарьян-Мар",
                "Ханты-Сансийск", "Анадырь", "Салехард"};
